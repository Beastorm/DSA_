...
**Problem Statement:** Given an array of integers A and an integer k. Find the total number of subarrays having bitwise XOR of all elements equal to k.
...
6.  If `xorVal` equals `B`, increment the `count` by 1.
