...
**Output:**  
 `[[-1,-1,2],[-1,0,1]]`  
**Explanation:**  
 Out of all possible unique triplets, `[-1,-1,2]` and `[-1,0,1]` satisfy the condition of summing up to zero with i!=j!=k.  
...
**Output:**  
 `[[-1,0,1]]`  
**Explanation:**  
 Out of all possible unique triplets, `[-1,0,1]` satisfies the condition of summing up to zero with i!=j!=k.
