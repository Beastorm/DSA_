...
### Logic:
     The rightmost set bit we extract represents a specific bit position where the *missing* number and the *repeating* number differ   
     (i.e., one number has a `0` at this position, and the other has a `1`).   
