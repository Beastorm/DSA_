## Find the number that appears once among the other numbers that appear twice
...
public:
    ...
    int getSingleElement(vector<int>& arr) {
        ...
        // Step 2: Declare and initialize a hash array of size maxi+1
...
### Algo:
We will perform the XOR of all elements of the array using a loop, and the final XOR will be the answer.
