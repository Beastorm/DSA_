...
public:
    ...
    int longestSubarray(vector<int> &nums, int k){
        ...
        // Pointers to mark the start and end of the window
        int left = 0, right = 0;
...
int main() {
    ...
    // Function call to find the length of the longest subarray having sum k
    int ans = sol.longestSubarray(nums, k);

    cout << "The length of the longest subarray having sum k is: " << ans;
