...
```
**Wave form (column-wise traversal):**  
``` cpp
#include <bits/stdc++.h>
using namespace std;
...
---
## Spiral Form
Spiral form (Spiral Traversal of a Matrix)
...
Spiral Traversal Diagram (like the image)
...
### Transpose Matrix In-Place (Only for Square Matrix `n × n`)
