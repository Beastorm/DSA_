...
Node* convertArr2DLL(vector<int> arr) {
    ...
    for (int i = 1; i < arr.size(); i++) {
        ...
        last->next = temp; // Set 'next' of the previous node to the new node
        last = temp; // Move 'prev' to the new node
    }
