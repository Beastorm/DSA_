...
**Note:**  
Two strings are *anagrams* if one string can be made by *rearranging* the characters of the other.
**Conditions for being anagrams**  
- Both strings must have the *same length*
- They must contain the *same characters with the same frequencies*
