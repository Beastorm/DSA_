...
## String Matching Without Rabin–Karp

Below are common string matching methods that do **not** use Rabin–Karp (hashing).
...
> If current window hash is `H`, remove the leftmost character and add the new rightmost character:  
