...
> **Note:** You can’t return `0` just because length `1` doesn’t match, because you might think a longer prefix-suffix could still match.  
...
> ✅ You can early return `0` if: `s[0] != s[n-1]`  
...
> **So:**  
> - If you want the **maximum length**, don’t return early after checking length `1`.  
