...
- check: `3 > 2` → update (ties could go either way, but here it updates):
  - `start = 2 - (3-1)/2 = 2 - 1 = 1`
  - `end   = 2 + 3/2     = 2 + 1 = 3`
Best: `"aba"`
