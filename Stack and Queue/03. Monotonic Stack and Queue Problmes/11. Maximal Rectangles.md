...
**Output:**   6  
**Explanation:**    
The largest rectangle of only 1's has an area of 6, formed by the 2×3 block of 1's in rows 1 and 2, columns 2 to 4.
...
private:
    ...
    int largestRectangleArea(vector<int> &heights) {
        ...
        for(int i=0; i < n; i++) {
            ...
            elements are not the smaller element */
            while(!st.empty() && 
                ...
                // Next smaller element index for the popped element is the current index
                nse = i;
        ...
        while(!st.empty()) {
            ...
            // NSE for such elements is the size of the array
            nse = n;
...
public:
    ...
    int maximalAreaOfSubMatrixOfAll1(vector<vector<int>> &matrix){
        ...
        for(int i = 0; i < n; i++) {
            ...
            // Get the largest area for the current level
