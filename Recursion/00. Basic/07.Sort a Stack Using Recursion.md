...
### Diagram:
![Recursive Sort Stack](https://github.com/Beastorm/DSA_/blob/4caf9fa578be6ed07a70ec782015e835a4cfc487/junk/sort_stack.png?raw=true)  
*Recursive stack sorting algorithm - pops all elements until stack is empty (base case), then inserts each element back in sorted order during the return phase, resulting in a sorted stack.*
