...
**Problem Statement:**   
Given a set (or array) of **distinct** elements, print all possible subsets (also called the power set).
...
- No duplicates in input (distinct elements)
...
### Diagram:
![Print Subsets (Power Set)](https://github.com/Beastorm/DSA_/blob/02e9ec4d4defe6b7bc5dfc0f1686857b09ebf320/junk/subset_print.png?raw=true)  
*Recursion tree for generating the power set of string "ab" - shows how the input string shrinks and output string grows through include/exclude decisions, producing all 4 subsets.*
