...
### Diagram:
![Recursive Reverse Stack](https://github.com/Beastorm/DSA_/blob/0ddbc9c3bca6b67a90ef9f2b1f8d6f8818607dd8/junk/reverse_stack.png?raw=true)  
*Recursive stack reversal algorithm - pops all elements until empty (base case), then inserts each element at the bottom during return phase, effectively reversing the stack order.*
