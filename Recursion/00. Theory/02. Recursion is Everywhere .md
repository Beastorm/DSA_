...
- **Idea:**  
  Define the function by specifying its inputs and outputs.  
...
- **Example 1: Generating All Subsets**
  ...
  - **Example Trace for arr = [1, 2]:**
      ![Generate Subsets of [1, 2]](https://github.com/Beastorm/DSA_/blob/2e2a5581ea41a05c2a9f2e5a3b848687d949d7c4/junk/gen_subset_.png?raw=true)  
      *Complete recursion tree showing how generateSubsets() builds all subsets of [1, 2] using pick/not-pick pattern with state tracking - generates [1,2], [1], [2], and [] in DFS order.*
