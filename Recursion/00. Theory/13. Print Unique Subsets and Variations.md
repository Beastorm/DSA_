...
### Diagram:
![Unique Subsequences of "aab"](https://github.com/Beastorm/DSA_/blob/91476fb6f98ad8ffc7727924b8f253bfdee5318a/junk/unique_subsequence.png?raw=true)  
*Recursion tree for generating unique subsequences of "aab" - shows all paths including duplicates (red), with a Set data structure filtering them out to produce the final unique list.*
...
## Subsets or Subsequences in lexicographical order
#### Steps:
