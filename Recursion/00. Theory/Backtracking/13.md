...
**Explanation:**  
There are 2 solutions for N=4. Each row has exactly one queen, and no two queens attack each other.
...
```
**Explanation:**  
There is only one way to place a queen on a 1×1 board.
...
**Explanation:**  
It is not possible to place 3 queens on a 3×3 board so that no two queens threaten each other.
