...
- Natural mathematical definition (n! = n × (n-1)!)
...
void factParam(int i, long long result) {
    if (i < 1) {
        cout << result << endl;
        return;
    }
    factParam(i - 1, result * i);
}

long long factFunc(int n) {
    if (n <= 1) return 1;
    return n * factFunc(n - 1);
}

void powerParam(int base, int exp, long long result) {
    if (exp == 0) {
        cout << result << endl;
        return;
    }
    powerParam(base, exp - 1, result * base);
}
...
int main() {
    cout << "SUM OF 1 TO 5" << endl;
    cout << "Parameterized: ";
    sumParam(5, 0);
    cout << "Functional: " << sumFunc(5) << endl;
    
    cout << "FACTORIAL OF 5" << endl;
    cout << "Parameterized: ";
    factParam(5, 1);
    cout << "Functional: " << factFunc(5) << endl;
    
    cout << "POWER 2^10" << endl;
    cout << "Parameterized: ";
    powerParam(2, 10, 1);
    cout << "Functional: " << powerFunc(2, 10) << endl;
