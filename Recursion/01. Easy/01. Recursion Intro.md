...
### 1. Head Recursion (Print After Recursive Call)
### 2. Tail Recursion (Print Before Recursive Call)
...
┌─────────────────┐
│ countUpHead(0)  │ ← Base case, return
├─────────────────┤
│ countUpHead(1)  │ ← Waiting
├─────────────────┤
│ countUpHead(2)  │ ← Waiting
├─────────────────┤
│ countUpHead(3)  │ ← Waiting
├─────────────────┤
│ countUpHead(4)  │ ← Waiting
├─────────────────┤
│ countUpHead(5)  │ ← Waiting
└─────────────────┘
...
countUpHead(0) returns
  ↓
countUpHead(1) resumes → Print 1
  ↓
countUpHead(2) resumes → Print 2
  ↓
countUpHead(3) resumes → Print 3
  ↓
countUpHead(4) resumes → Print 4
  ↓
countUpHead(5) resumes → Print 5
  ↓
Done
...
┌─────────────────┐
│ countUpTail(1,5)│ ← Print 1, then call (2,5)
└─────────────────┘
Output: 1

Call countUpTail(2, 5)
┌─────────────────┐
│ countUpTail(2,5)│ ← Print 2, then call (3,5)
├─────────────────┤
│ countUpTail(1,5)│ ← Waiting
└─────────────────┘
Output: 1 2

Call countUpTail(3, 5)
┌─────────────────┐
│ countUpTail(3,5)│ ← Print 3, then call (4,5)
├─────────────────┤
│ countUpTail(2,5)│ ← Waiting
├─────────────────┤
│ countUpTail(1,5)│ ← Waiting
└─────────────────┘
Output: 1 2 3
...
┌─────────────────┐
│ countUpTail(4,5)│ ← Print 4, then call (5,5)
├─────────────────┤
│ countUpTail(3,5)│ ← Waiting
├─────────────────┤
│ countUpTail(2,5)│ ← Waiting
├─────────────────┤
│ countUpTail(1,5)│ ← Waiting
...
┌─────────────────┐
│ countUpTail(5,5)│ ← Print 5, then call (6,5)
├─────────────────┤
│ countUpTail(4,5)│ ← Waiting
├─────────────────┤
│ countUpTail(3,5)│ ← Waiting
├─────────────────┤
│ countUpTail(2,5)│ ← Waiting
...
┌─────────────────┐
│ countUpTail(6,5)│ ← current > n, BASE CASE, return
├─────────────────┤
│ countUpTail(5,5)│
├─────────────────┤
│ countUpTail(4,5)│
...
**Example:**
Calling `countUp(5)` recursively → 5 stack frames used
...
**Symptoms:**
- Program crashes
- “Segmentation Fault” or “StackOverflowError”
