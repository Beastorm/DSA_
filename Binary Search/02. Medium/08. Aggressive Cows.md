...
Placement:  
Place C1 at stall 0.  
To place C2, we need a stall at least 4 units away. The next available stall is 4, which is 4-0=4 away. So place C2 at 4.  
To place C3, we need a stall at least 4 units away from 4. The next is 9 (9-4=5). Place C3 at 9.  
To place C4, we need a stall at least 4 units away from 9. There are no more stalls.  
Result: We could only place 3 cows, not 4. So, a minimum distance of 4 is not possible. The diagram likely shows the distances if we could place them, but the conclusion is that it fails.   
