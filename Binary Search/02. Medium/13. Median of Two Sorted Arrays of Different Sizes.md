...
After merging, if the length of the new array is even, we return the average of the two middle elements; otherwise, we simply return the middle element as the median.
...
console.log(sol.findMedianSortedArrays([1, 3], [2]));
```
### Complexity Analysis:
