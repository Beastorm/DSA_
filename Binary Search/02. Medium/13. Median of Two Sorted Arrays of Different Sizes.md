...
### Example 1: Total Even Length

-   **Input:**
    -   `arr1[] = {1, 3, 4, 7, 10, 12}`
    -   `arr2[] = {2, 6, 15, 20}`
-   **Merged Array:** `{1, 2, 3, 4, **6**, **7**, 10, 12, 15, 20}`
-   **Total Length:** `10` (Even)
-   **Median:** `(6 + 7) / 2.0 = 6.5`
-   **Result:** `6.5`


### Example 2: Total Odd Length
...
-   **Total Length:** `7` (Odd)
-   **Median:** The middle element is `5`.
-   **Result:** `5`


### Example 3: No Overlap Between Arrays

-   **Input:**
    -   `arr1[] = {1, 2, 3}`
    -   `arr2[] = {10, 20, 30, 40}`
-   **Merged Array:** `{1, 2, 3, **10**, 20, 30, 40}`
-   **Total Length:** `7` (Odd)
...
-   **Total Length:** `5` (Odd)
-   **Median:** The middle element is `30`.
-   **Result:** `30`


### Example 5: Median is not in Original Arrays

-   **Input:**
    -   `arr1[] = {10, 20, 40, 50}`
    -   `arr2[] = {5, 15, 25, 35}`
-   **Merged Array:** `{5, 10, 15, **20**, **25**, 35, 40, 50}`
-   **Total Length:** `8` (Even)
