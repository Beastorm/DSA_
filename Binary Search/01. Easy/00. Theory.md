...
### 1. The Core Idea: Halving the Problem
...
### Polarity 1: Minimize the Value (Find the First `true`)
...
```
### Polarity 2: Maximize the Value (Find the Last `true`)
