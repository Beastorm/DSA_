...
/**
 * @brief Finds a peak element in an array using a modified binary search.
 * This function is a C++ implementation of the handwritten code in the image.
 *
...
int main() {
    ...
    std::cout << "A peak in {1,2,3,4,5,6,7,8,5,1} is at index: " << findPeakElement(arr1) << std::endl; // Expected: 7

    std::vector<int> arr2 = {1, 2, 1, 3, 5, 6, 4};
    std::cout << "A peak in {1,2,1,3,5,6,4} is at index: " << findPeakElement(arr2) << std::endl; // Expected: 1 or 5
...
/**
 * @brief A direct transcription of the handwritten code from the provided images.
 * @param arr The input vector of integers.
 * @param n The size of the vector.
 * @return The index of a peak element, or -1.
 */
