...
**Problem Statement:**   
Given a Binary Tree, determine whether the given tree is symmetric or not. A Binary Tree would be Symmetric when its mirror image is exactly the same as the original tree. If we were to draw a vertical line through the centre of the tree, the nodes on the left and right sides would be mirror images of each other.

<img src="https://www.helpmestudybro.com/wp-content/uploads/2021/01/SymmetricTree.png" alt="Symmetric Tree Example" width="300"/>
...
We compare left and right parts in a mirrored way — the left child of the left side is compared with the right child of the right side, and vice versa.
...
<img src="https://static.takeuforward.org/content/8.png-JBFezt2Z" alt="TakeUForward Solution 8" width="500"/>
